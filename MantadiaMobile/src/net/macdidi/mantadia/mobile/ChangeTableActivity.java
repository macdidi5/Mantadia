...
public class ChangeTableActivity extends Activity {
    ...
    private void processControllers() {
        table_status.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                // 準備啟動確認換桌元件
                Intent intent = new Intent(ChangeTableActivity.this,
                        ChangeTableConfirmActivity.class);
    ...
    private void getTableNotEmpty() {
        ...
        String url = HttpClientUtil.MOBILE_URL
                + "TableStatusServlet.do?type=CHANGE";
        // 傳送請求並取得回傳的資料
        ...
        try {
            ...
            if (list.size() == 0) {
                ...
                ab.setMessage(R.string.change_table_no_orders_etxt);
